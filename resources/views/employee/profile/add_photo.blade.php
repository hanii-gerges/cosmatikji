...
<div class="page_content">
    ...
    <div class="form">
        <form class="form-horizontal" action="{{route('employee.store.photo')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="hidden" name="old_photo" value="{{$employee->profile_photo_path}}">
                </div>
            </div>
            <div class="form-group">
