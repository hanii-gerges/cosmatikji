    ...
    <table class="table">
        <tr class="h4 text-center">
            ...
            <td class="text-center">
                <a href="{{route('admin.edit.img',$img->id)}}" class="glyphicon glyphicon-pencil text-info"></a>
                <a href="{{route('admin.delete.img',$img->id)}}" class="glyphicon glyphicon-trash text-danger" onclick="return confirm('هل انتا متأكد من انك تريد حذف الموظف');"></a>
            </td>
        </tr>
            @endforeach
